    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{ url('admin/classes/create') }}">Add Class</a>
                </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                        <form role="form" method="post" action="{{ url('admin/classes/store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('class') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('class') }}" name="class" id="class" placeholder="Class">
                                            @if ($errors->has('class'))
                                                <span class="help-block">
