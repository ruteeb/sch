            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                        <form role="form" method="post" action="{{ url('admin/invoices/'.$invoice->id.'/update') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group{{ $errors->has('student') ? ' has-error' : '' }}">
                                            ...
                                            <select class="form-control bs-select" data-live-search="true" data-size="8" name="student" id="student">
                                                ...
                                                @foreach($contracts as $contract)
                                                    ...
                                                    <option {{ $contract->id == $invoice->contract_id ? 'selected' : '' }} value="{{ $student->id }}">{{ $student->first_name . ' ' . $student->last_name }}</option>
                                                @endforeach
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('date') ? ' has-error' : '' }}">
                                            ...
                                            <input type="date" class="form-control" value="{{ $invoice->date or old('date') }}" name="date" id="date" placeholder="Date">
                                            @if ($errors->has('date'))
                                                <span class="help-block">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('value') ? ' has-error' : '' }}">
                                            ...
                                            <input type="number" class="form-control" value="{{ $invoice->value or old('value') }}" name="value" id="value" placeholder="Value">
                                            @if ($errors->has('value'))
                                                <span class="help-block">
