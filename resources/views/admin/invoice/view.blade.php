                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> View Material</span>
                        </div>
                    </div><!-- /.portlet-title -->
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <ul class="list-unstyled profile-nav">
                                    <li>
                                        <img class="full_width" src="{{ asset('admin/files/images/materials/') }}/{{ $material->image }}">
                                    </li>
                                </ul>
                            </div><!-- /.col-md-3 -->
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-12 profile-info">
                                        <h1 class="font-orange sbold uppercase">{{ $material->title}}</h1>

                                        <p>
                                            <strong>Content: </strong> <br>
                                            {!! nl2br($material->content) !!}
                                        </p>
                    ...
                    <div class="control-item">
                        <a href="{{ url('admin/materials') }}" class="btn btn-warning"><i class="fa fa-chevron-left"></i> Back</a>
