            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                        <form role="form" method="post" action="{{ url('admin/courses/'.$course->id.'/update') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('course') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" value="{{ $course->title }}" name="course" id="course" placeholder="Course">
