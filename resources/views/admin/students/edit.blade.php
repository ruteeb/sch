    ...
    <div class="page-content">
        ...
        <div class="portlet light bordered" id="form_wizard_1">
            ...
            <div class="portlet-body form">
                <form role="form" method="post"  action="{{ url('admin/students/'.$student->id.'/update') }}" id="submit_form" enctype="multipart/form-data">
                                ...
                                <div class="tab-pane active" id="tab1">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" value="{{ $student->first_name }}" name="first_name" id="first_name" placeholder="First Name">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" value="{{ $student->last_name }}" name="last_name" id="last_name" placeholder="Last Name">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                            ...
                                            <input type="email" class="form-control" value="{{ $student->email }}" name="email" id="email" placeholder="E-mail">
                                            @if ($errors->has('email'))
                                                <span class="help-block">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                            <label class="control-label" for="password">Password <small class="font-orange">(Not Required If you don't want to modify the password.)</small></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                                            <label class="control-label" for="image">Image <small class="font-orange">(Not Required If you don't want to modify the image.)</small></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('birthday') ? ' has-error' : '' }}">
                                            ...
                                            <input type="date" class="form-control" value="{{ $student->birthday }}" name="birthday" id="birthday" placeholder="Birthday">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('bsn_number') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" value="{{ $student->bsn_number }}" name="bsn_number" id="bsn_number" placeholder="Bsn Number">
                                ...
                                <div class="tab-pane" id="tab2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('post_code') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" value="{{ $student->post_code }}" name="post_code" id="post_code" placeholder="Post Code">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('home_number') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" value="{{ $student->home_number }}" name="home_number" id="home_number" placeholder="Home Number">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('extension') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" value="{{ $student->extension }}" name="extension" id="extension" placeholder="Extension">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('street_name') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" value="{{ $student->street_name }}" name="street_name" id="street_name" placeholder="Street Name">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" value="{{ $student->city }}" name="city" id="city" placeholder="City">
                                            @if ($errors->has('city'))
                                                <span class="help-block">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('province') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" value="{{ $student->province }}" name="province" id="province" placeholder="Province">
                                ...
                                <div class="tab-pane" id="tab3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('start_borrow') ? ' has-error' : '' }}">
                                            ...
                                            <input type="date" class="form-control" value="{{ $student->start_borrow }}" name="start_borrow" id="start_borrow" placeholder="Start Borrow">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('end_borrow') ? ' has-error' : '' }}">
                                            ...
                                            <input type="date" class="form-control" value="{{ $student->end_borrow }}" name="end_borrow" id="end_borrow" placeholder="End Borrow">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('start_residence') ? ' has-error' : '' }}">
                                            ...
                                            <input type="date" class="form-control" value="{{ $student->start_residence }}" name="start_residence" id="start_residence" placeholder="Start Residence">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('end_residence') ? ' has-error' : '' }}">
                                            ...
                                            <input type="date" class="form-control" value="{{ $student->end_residence }}" name="end_residence" id="end_residence" placeholder="End Residence">
