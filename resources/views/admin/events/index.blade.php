                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ url('admin/events/create') }}" id="sample_editable_1_new" class="btn sbold green"> Add New
                        ...
                        <form action="{{ url('admin/admins/multidelete') }}" method="post">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $event->title }}</td>
                                    <td>{{ str_limit($event->content, 100) }}</td>
                                    <td><img class="view_index" src="{{ asset('admin/files/images/events/') }}/{{ $event->image }}"></td>
                                    <td>{{ $event->created_at->format('d M Y') }}</td>
                                    <td>
                                        <a href="{{ url('admin/events/'.$event->id.'/edit') }}" class="btn btn-info"><i class="fa fa-refresh"></i> Edit</a>
                                        <a href="{{ url('admin/events/'.$event->id.'/view') }}" class="btn btn-warning"><i class="fa fa-eye"></i> View</a>
                                        @if($event->active == 1)
