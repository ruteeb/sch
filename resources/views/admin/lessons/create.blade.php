    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{ url('admin/lessons/create') }}">Add Lesson</a>
                </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                        <form role="form" method="post" action="{{ url('admin/lessons/store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group{{ $errors->has('class') ? ' has-error' : '' }}">
                                            ...
                                            <select class="bs-select form-control" name="class" data-live-search="true" data-size="8" id="class" >
                                                ...
                                                @foreach($classes as $class)
                                                    <option {{ old('class') == $class->id ? 'selected' : '' }} value="{{ $class->id }}">{{ $class->title }}</option>
                                                @endforeach
                                            </select>
                                            @if ($errors->has('class'))
